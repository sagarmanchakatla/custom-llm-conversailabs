...
// // Grab your Portkey / OpenRouter creds
// const portkey = new Portkey({
//   apiKey: process.env.PORTKEY_API_KEY!, // set in .env
//   virtualKey: process.env.OPENROUTER_VIRTUAL_KEY!, // your OpenRouter virtual-key
// });
